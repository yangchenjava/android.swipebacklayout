package com.yangc.swipebacklayout.widget;
...
import com.yangc.swipebacklayout.R;
import com.yangc.swipebacklayout.helper.ViewDragHelper;
...
public class SwipeBackLayout extends FrameLayout {
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		mInLayout = true;
		if (mContentView != null) mContentView.layout(mContentLeft, mContentTop, mContentLeft + mContentView.getMeasuredWidth(), mContentTop + mContentView.getMeasuredHeight());
		mInLayout = false;
	}
